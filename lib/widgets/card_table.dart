      ...
      children: const [
        ...
        TableRow(
          children: [
            ...
            _SingleCard(color: Colors.deepOrangeAccent, icon: Icons.assignment, text: "Bills",)
          ]
        ),
        TableRow(
          children: [
            _SingleCard(color: Colors.blueAccent, icon: Icons.movie, text: "Entertainment",),
            _SingleCard(color: Colors.green, icon: Icons.storefront_rounded, text: "Grocery",)
          ]
        ),
        TableRow(
          children: [
